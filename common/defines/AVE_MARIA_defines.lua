...
NDefines.NDiplomacy.DEMESNE_MAX_SIZE_DUKE_MULT = 1.5
...
NDefines.NDiplomacy.DEMESNE_BASE_MAX_SIZE = 10.0
...
NDefines.NMilitary.CONTESTED_TERRITORY_WARSCORE_MULTIPLIER = 10
